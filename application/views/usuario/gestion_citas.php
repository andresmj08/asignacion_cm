...
<body>
  ...
  <div class="page-header">
	...
	<div class="container">
		...
		<a href=""><button type="button" class="btn btn-info btn-lg btn-block">Historico de Citas</button></a>
		<a href="proximas"><button type="button" class="btn btn-default btn-lg btn-block">Proximas Citas</button></a>
		<a href=""><button type="button" class="btn btn-info btn-lg btn-block"></button></a>
